...
<head>
    <meta charset="utf-8">
    <title>PHP Techy's Shopping</title>
                        ...
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    ...
                                    <li>Trendy 25silver jewellery, save up 35% off today <a href="shop.html">Shop now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="/"><img src="{{ asset('assets/imgs/logo/'.$LOGO_NAME) }}" alt="logo" style="border: 2px solid #000;"></a>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="product-details.html"><img src="{{ asset('assets/imgs/banner/menu-banner.jpg') }}" alt="PHP Techy"></a>
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> {{ $PHONE_NUMBER }} </p>
                    </div>
                        ...
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.php">
                                    <img alt="PHP Techy" src="{{ asset('assets/imgs/theme/icons/icon-heart.svg') }}" >
                                    <span class="pro-count white">4</span>
                                </a>
                            </div>
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="cart.html">
                                    <img alt="PHP Techy" src="{{ asset('assets/imgs/theme/icons/icon-cart.svg') }}" >
                                    ...
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="PHP Techy" src="{{ asset('assets/imgs/shop/thumbnail-3.jpg') }}" ></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="PHP Techy" src="{{ asset('assets/imgs/shop/thumbnail-4.jpg') }}" ></a>
                                            </div>
                                            <div class="shopping-cart-title">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@phptechy.com
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">PHP Techy</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>

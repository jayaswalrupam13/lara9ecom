                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>                                              
                                    ...
                                    <tr>
                                        ...
                                        <td class="image product-thumbnail"><img src="{{ asset(PRODUCT_FOLDER_PATH)}}/{{ $item->model->image }}" title="{{ $item->model->name }}" alt="{{ $item->model->name }}"></td>
                                        ...
                                        <td class="action" data-title="Remove" wire:click.prevent="deleteItemInCart('{{ $item->rowId }}')"><a href="#" class="text-muted"><i class="fi-rs-trash"></i></a></td>
                                    </tr>
                                    @endforeach
                                    <tr>
                                        <td colspan="6" class="text-end">
                                            <a href="#" class="text-muted" wire:click.prevent="emptyCart()"> <i class="fi-rs-cross-small"></i> Clear Cart</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>                            

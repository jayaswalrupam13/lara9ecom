<div class="header-action-icon-2">
    <a class="mini-cart-icon" href="{{ route('shop.cart') }}">
        <img alt="cart" src="{{ asset(THEME_FOLDER_PATH.'/icons/icon-cart.svg') }}">
        ...
        <ul>
            ...
            <li>
                <div class="shopping-cart-img">
                    <a href="{{ route('product.details', ['slug' => $item->model->slug]) }}"><img alt="{{ ucwords($item->model->name) }}" src="{{ asset(PRODUCT_FOLDER_PATH)}}/{{ $item->model->image }}"></a>
                </div>

                        ...
                        <div class="order_review">
                            ...
                            <div class="table-responsive order_table text-center">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="image product-thumbnail"><img src="{{ asset(SHOP_FOLDER_PATH.'/product-1-1.jpg') }}" alt="#"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="image product-thumbnail"><img src="{{ asset(SHOP_FOLDER_PATH.'/product-2-1.jpg') }}" alt="#"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="image product-thumbnail"><img src="{{ asset(SHOP_FOLDER_PATH.'/product-3-1.jpg') }}" alt="#"></td>
